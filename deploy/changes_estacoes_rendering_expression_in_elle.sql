...
<states>
  <Persistence__FILTER_EXPRESSION_LEGEND_PERSISTENCE_DEFINITION_NAME id="760">
    ...
    <itemStringArray type="list">
      ...
      <item type="string"><![CDATA[tip_estac = ''Hidrométrica'' and (estado  <>  ''Operacional'' or estado is null)]]></item>
      <item type="string">tip_estac = ''Pluviométrica'' and estado = ''Operacional''</item>
      <item type="string"><![CDATA[tip_estac = ''Pluviométrica'' and (estado  <>  ''Operacional'' or estado is null)]]></item>
    </itemStringArray>
