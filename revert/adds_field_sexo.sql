-- Revert utentes:adds_field_sexo from pg
...
ALTER TABLE utentes.exploracaos DROP COLUMN sexo_gerente;
ALTER TABLE utentes.utentes DROP COLUMN sexo_gerente;
DROP TABLE domains.sexo;
