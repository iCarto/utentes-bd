-- Revert utentes:alter_table_utentes_fontes_with_inventario_columns from pg

BEGIN;

alter table inventario.fontes drop constraint fontes_tipo_agua_fkey1;
...
ALTER TABLE inventario_dominios.tip_fonte OWNER TO postgres;
GRANT SELECT ON TABLE inventario_dominios.tip_fonte TO sirha_base_user;

INSERT INTO inventario_dominios.tip_fonte
    (category, key, value, ordering, parent, tooltip)
VALUES
    (NULL, 'Furo', NULL, 2, 'Subterrânea', NULL)
    , (NULL, 'Poço', NULL, 7, 'Subterrânea', NULL)
    , (NULL, 'Albufeira', NULL, 1, 'Superficial', NULL)
    ,  (NULL, 'Lago', NULL, 3, 'Superficial', NULL)
    ,  (NULL, 'Nascente', NULL, 5, 'Superficial', NULL)
    ,  (NULL, 'Rio', NULL, 9, 'Superficial', NULL)
    ,  (NULL, 'Mar', NULL, 4, 'Superficial', NULL)
    ,  (NULL, 'Poço aberto', NULL, 8, 'Subterrânea', NULL)
    ,  (NULL, 'Piezómetro', NULL, 6, 'Subterrânea', NULL)
    ,  (NULL, 'Outros', NULL, 10, 'Subterrânea', NULL)
;


ALTER TABLE inventario.fontes
    ADD FOREIGN KEY (tip_fonte)
    REFERENCES inventario_dominios.tip_fonte(key) ON UPDATE CASCADE
;


ALTER TABLE domains.red_monit ALTER COLUMN category DROP DEFAULt;
UPDATE domains.red_monit SET category = NULL;
ALTER TABLE domains.red_monit SET SCHEMA inventario_dominios;


ALTER TABLE utentes.fontes
    DROP COLUMN red_monit
   , DROP COLUMN bombeo
   , DROP COLUMN prof_pozo
