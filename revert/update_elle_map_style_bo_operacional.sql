-- Revert utentes:update_elle_map_style_bo_operacional from pg
...
<states>
  ...
  <Persistence__PictureMarkerSymbol id="7">
    ...
    <rotation type="double">0.0</rotation>
    <description type="string">Hidrométrica - Bom</description>
    <referenceSystem type="integer">0</referenceSystem>
    <mask type="null"></mask>
    <isShapeVisible type="boolean">true</isShapeVisible>
  ...
  <Persistence__PictureMarkerSymbol id="14">
    ...
    <rotation type="double">0.0</rotation>
    <description type="string">Hidrométrica - Não Bom</description>
    <referenceSystem type="integer">0</referenceSystem>
    <mask type="null"></mask>
    <isShapeVisible type="boolean">true</isShapeVisible>
    <bgImage type="reference">
  ...
  <Persistence__PictureMarkerSymbol id="20">
    ...
    <rotation type="double">0.0</rotation>
    <description type="string">Pluviométrica - Bom</description>
    <referenceSystem type="integer">0</referenceSystem>
    <mask type="null"></mask>
    <isShapeVisible type="boolean">true</isShapeVisible>
    <bgImage type="reference">
  ...
  <Persistence__PictureMarkerSymbol id="26">
    ...
    <rotation type="double">0.0</rotation>
    <description type="string">Pluviométrica - Não Bom</description>
    <referenceSystem type="integer">0</referenceSystem>
    <mask type="null"></mask>
    <isShapeVisible type="boolean">true</isShapeVisible>
    <bgImage type="reference">
