-- Revert utentes:create_table_facturacao from pg
...
DROP TABLE utentes.facturacao;

ALTER TABLE utentes.exploracaos DROP COLUMN pago_lic;
ALTER TABLE utentes.exploracaos DROP COLUMN fact_tipo;
...
DROP TABLE domains.facturacao_fact_estado;
